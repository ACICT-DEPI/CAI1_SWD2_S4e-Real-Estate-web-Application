...
function Details() {
	...
	const handleUpdate = (property) => {
		const userEmail = "julianageorgeeshak@gmail.com"; // another test email
		...
		<div className="flex flex-col items-center xl:flex-row">
			<div className="container mx-auto p-8 flex flex-col items-center gap-5 w-full">
				{properties.map((property) => (
					<div
						key={property._id}
						className="property-card bg-white shadow-lg rounded-lg p-5 flex flex-col items-center w-full max-w-4xl" // Set max width here
					>
						<div className="mb-5">
						...
						<img
							src={property?.image}
							alt={property?.title}
							className="h-[400px] w-full rounded-xl object-cover mb-4" 
						/>
			...
			{selectedrecidency && (
				<Update
					property={selectedrecidency}
					onClose={() => setSelectedrecidency(null)}
